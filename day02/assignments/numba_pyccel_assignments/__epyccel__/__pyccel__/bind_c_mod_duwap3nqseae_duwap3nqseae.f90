module bind_c_mod_duwap3nqseae_duwap3nqseae

  use mod_duwap3nqseae_duwap3nqseae, only: solve_2d_nonlinearconv_pyccel
...
end module bind_c_mod_duwap3nqseae_duwap3nqseae
