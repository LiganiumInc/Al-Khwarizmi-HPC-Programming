module bind_c_mod_rhzo4tra78mi_rhzo4tra78mi

  use mod_rhzo4tra78mi_rhzo4tra78mi, only: solve_1d_linearconv_pyccel
...
end module bind_c_mod_rhzo4tra78mi_rhzo4tra78mi
