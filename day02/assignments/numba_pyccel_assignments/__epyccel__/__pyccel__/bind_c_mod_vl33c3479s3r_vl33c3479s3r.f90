module bind_c_mod_vl33c3479s3r_vl33c3479s3r

  use mod_vl33c3479s3r_vl33c3479s3r, only: solve_2d_burger_pyccel
...
end module bind_c_mod_vl33c3479s3r_vl33c3479s3r
